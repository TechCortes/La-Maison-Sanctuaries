    ...
    <div className="bg-wine text-bone">
      ...
      <section className="py-28 md:py-36">
        <div className="mx-auto grid max-w-[1400px] gap-16 px-6 md:grid-cols-[1fr_1.5fr] md:gap-24 md:px-10">
          <FadeIn>
            <p className="eyebrow !text-bone">A Private Members' Experience</p>
          </FadeIn>
          <FadeIn delay={0.15}>
            ...
            <p className="mt-8 max-w-xl text-base leading-relaxed text-bone/75">
      ...
      {/* LOCATION */}
      <section className="border-t border-bone/15 py-28 md:py-36">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10">
          <div className="grid gap-16 md:grid-cols-2 md:gap-20">
            <FadeIn>
              <p className="eyebrow !text-bone">A Discreetly Connected Retreat</p>
              <h2 className="mt-6 font-display text-5xl leading-[1.05] text-bone md:text-6xl">
                Saint-Émilion
                <em className="italic text-bone/70"> · Bordeaux.</em>
              </h2>
              <div className="mt-8 max-w-md space-y-5 text-base leading-relaxed text-bone/80">
                <p>
            ...
            <FadeIn delay={0.15}>
              <div className="overflow-hidden border border-bone/15 bg-bone p-4">
                <img
                  src={map}
